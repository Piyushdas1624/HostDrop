...
def run_all_tests():
    print("=" * 64)
    print("  RUNNING TURBOSHARE TEST SUITE")
    print("=" * 64)

    test_dir = tempfile.mkdtemp(prefix="turboshare_test_")
    ...
    try:
        ...
        assert_true(turboshare.UPLOAD_DIR == new_recv, "Server internal UPLOAD_DIR state updated")
        ...
        with open(os.path.join(subfolder, "document.txt"), "w", encoding="utf-8") as f:
            f.write("Hello TurboShare ZIP Engine!")
        ...
        bad_path = turboshare.safe_path(test_recv, "../../../Windows/System32/cmd.exe")
